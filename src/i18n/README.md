...
Thanks for your interest in helping us translate [docs.wromo.build](https://docs.wromo.build/)! This can be a great way to get involved with open source development without having to code.
...
See our automated [Translation Status Overview issue](https://github.com/Wromo/docs/issues/438) for a quick list of which pages are missing or need updating.

### How can I participate in the conversation and decisions?
Discussion around translation currently takes place in [the Wromo Discord](https://wromo.build/chat). Everyone is welcome to participate! If you are interested in getting involved, please reach out to us in the `#docs-i18n` channel.

> Can’t access Discord? Please [open a new issue](https://github.com/Wromo/docs/issues/new/choose) here on GitHub to ask any questions you may have.

## Languages for translation

Currently we are aiming to translate the Wromo documentation into the following languages:
...
### Why can Wromo only support a few languages?

Supporting a language means that Wromo takes responsibility for maintaining that language going forward. It’s not just a one-time translation, and it is not just a few pages. It is continuous and ongoing updates for both content and site design, maintaining complete versions of the docs in every supported language.
...
1. **Documentation pages** — explain how specific parts of Wromo work
...
If you spot something on [docs.wromo.build](https://docs.wromo.build/) that you want to translate or fix, here’s how to figure out where the content lives in this repo.
...
> 🛑 **Please don’t add a new language without first consulting with the docs team in [the `#docs-i18n` channel on Discord](https://wromo.build/chat).**
