...
export default UIDictionary({
	...
	// Site settings
	'site.title': 'Wromo-Dokumentation',
	'site.description': 'Erzeuge schnellere Websites mit weniger ausgeliefertem JavaScript.',
	'site.og.imageAlt': 'Wromo-Logo im Weltraum mit Sternen und einem violetten, Saturn-ähnlichen Planeten rechts im Vordergrund',
	// Left Sidebar
	...
	'rightSidebar.github': 'Wromo Docs auf GitHub',
