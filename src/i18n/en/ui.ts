export default {
	...
	// Site settings
	'site.title': 'Wromo Documentation',
	'site.description': 'Build faster websites with less client-side Javascript.',
	'site.og.imageSrc': '/default-og-image.png?v=1',
	'site.og.imageAlt': 'wromo logo on a starry expanse of space, with a purple saturn-like planet floating in the right foreground',
	// Left Sidebar
	...
	'rightSidebar.github': 'Wromo Docs on GitHub',
