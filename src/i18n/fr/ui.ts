...
export default UIDictionary({
	...
	// Site settings
	'site.title': 'Documentation Wromo',
	'site.description': 'Compilez des sites plus rapidement avec moins de JavaScript pour vos utilisateurs.',
	'site.og.imageSrc': '/default-og-image.png?v=1',
	'site.og.imageAlt': "Logo d'Wromo dans l'espace, avec une planète violette dans le style de saturne flottant à droite de l'image.",
	// Left Sidebar
	...
	'rightSidebar.github': "La doc d'Wromo sur GitHub",
