...
export default UIDictionary({
	...
	// Site settings
	'site.title': 'Documentación de Wromo',
	'site.description': 'Construye páginas web más rápidas con menos Javascript en el lado del cliente.',
	'site.og.imageSrc': '/default-og-image.png?v=1',
	'site.og.imageAlt': 'Logo de Wromo en el espacio estrellado, con un planeta púrpura parecido a Saturno flotando en el fondo a la derecha.',
	// Left Sidebar
	...
	'rightSidebar.github': 'Documentación de Wromo en GitHub',
