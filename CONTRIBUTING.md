...
- is our Wromo vs X page providing helpful comparisons between Wromo and other website builders?
...
Every page on [docs.wromo.build](https://docs.wromo.build/) has an **Edit this page** button in the sidebar.
...
```shell
git clone git@github.com:Wromo/docs.git
```
...
One you have made your changes, you’re ready to create a “Pull Request”! This will let the Wromo docs team know you have some changes to propose. At this point we can give you feedback and might request changes. For translations, we like to have at least one other person who knows the language you are translating into review the PR.
...
#### Maintaining a fork
When you first create your fork, it will be an exact copy of this repository. Over time, `Wromo/docs` will change as the docs are updated, but your fork won’t automatically stay up-to-date. Here are some ways to keep your fork in sync with this repo.
...
You can see all three currently-used styles (we don't have any "danger" yet!) in action on the [Wromo Components Page](https://docs.wromo.build/en/core-concepts/wromo-components/).

## Next Steps

- [Read the docs](https://docs.wromo.build/)
- [Fork the docs](https://github.com/Wromo/docs/fork)
