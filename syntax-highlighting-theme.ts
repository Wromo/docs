...
export const tokens: IRawThemeSetting[] = [
	...
	{
		name: 'Misc blocks',
		scope: ['source.wromo meta.brace.round'],
		settings: {
			foreground: grey[2],
		},
	},
	...
	{
		name: '[Wromo] Embedded expressions as HTML props',
		scope: ['expression.embbeded.wromo'],
		settings: {
			foreground: red[0],
		},
	},
	{
		name: '[Wromo] Embedded expressions as HTML props',
		scope: ['expression.embbeded.wromo meta.brace'],
		settings: {
			foreground: grey[1],
		},
	},
	...
	},
	{
		...
		scope: ['source.wromo meta.brace.square', 'source.wromo meta.brace.round'],
		settings: {
			foreground: grey[2],
		},
	},
